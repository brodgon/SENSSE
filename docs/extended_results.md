...
The fold-wise analysis provides additional insight into the stability and robustness of the proposed framework across different train-test partitions. Consistent performance across folds suggests that the observed improvements are not driven by favorable data splits but rather reflect generalizable behavior.
